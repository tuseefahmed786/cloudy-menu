      ...
      <div className='flex sm:h-screen flex-col-reverse sm:flex-row'>
        ...
        <div className="flex gap-3 items-center">
         ...
         <div className="sm:mx-auto flex gap-2 flex-col items-center sm:w-full sm:max-w-sm">
            ...
            <p className='text-sm'>Sign up for a free account.
            </p>
          </div>
          ...
          <div className="pt-5 sm:pt-7 sm:mx-auto sm:w-full sm:max-w-sm">
            ...
            >
              <div>
                ...
                <div className="mb-3 mt-1">
                  <input
                    ...
                    className={`${isValidName ? "border-red-500 border-1  ring-red-500 text-red-500" : "border-0 ring-gray-300 text-gray-900"} block px-3 w-full rounded-md py-[9px] shadow-sm ring-1 ring-inset  placeholder:text-gray-400 sm:text-sm sm:leading-6`}
                  />
              ...
              <div>
                ...
                <div className="mt-1">
                  <input
                    ...
                    autoComplete="email"
                    className={`${isEmailValidate ? "border-red-500 border-1  ring-red-500 text-red-500" : "border-0 ring-gray-300 text-gray-900"} block px-3 w-full rounded-md py-[9px]  shadow-sm ring-1 ring-inset  placeholder:text-gray-400 sm:text-sm sm:leading-6`}
                  />
              ...
              <div>
                ...
                >
                  {isLoading ? <Isloading width="w-6" height="h-6" /> : 'Create Account'}
                </button>
              </div>
            </form>

            <p className="pt-2 flex gap-1 justify-center items-center
