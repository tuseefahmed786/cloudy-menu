      ...
      <div className='flex sm:h-screen flex-col-reverse sm:flex-row-reverse'>
        ...
        <div className="flex min-h-full flex-1 flex-col justify-center px-3 sm:px-6 py-5 sm:py-8 lg:px-8">
          ...
          <div className="pt-5 sm:pt-7 sm:mx-auto sm:w-full sm:max-w-sm">
            ...
            >
              <div>
                <label htmlFor="restaurantName" className="block text-base font-medium leading-6 text-gray-900">
              ...
              <div>
                ...
                <div className="mt-2">
                  <input
                    ...
                    autoComplete="email"
                    className={`${isEmailValidate ? "border-red-500 border-1  ring-red-500 text-red-500" : "border-0 ring-gray-300 text-gray-900"} block px-3 w-full rounded-md py-[14px]  shadow-sm ring-1 ring-inset  placeholder:text-gray-400 sm:text-sm sm:leading-6`}
                  />
              ...
              <div className='pt-3 sm:pt-3'>
                ...
                <div className="mt-2">
                  <input
                    ...
                    className="block px-3 w-full rounded-md border-0 py-[14px]  text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 sm:text-sm sm:leading-6"
                  />
                </div>
              </div>
              ...
              <div>
                <button
                  type="submit"
                  className="flex w-full justify-center rounded-md cloud-menu-bg mt-3 sm:mt-5 px-3 py-[14px]  text-sm font-semibold leading-6 text-white shadow-sm hover:bg-[#31ad5f] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                >
