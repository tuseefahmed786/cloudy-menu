...
const Subscription = () => {
  ...
  return (
    <div className="h-full flex flex-col items-center justify-start bg-gray-50 p-6">
      {/* Header */}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-4xl">
        ...
        <div className="bg-white border rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow duration-300">
          ...
          <p className="text-gray-500 mt-2">
            Billed Monthly at{" "}
            <span className="font-bold text-gray-600">AED 49/Month</span>.
          </p>
        ...
        <div className="bg-white border rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow duration-300">
          ...
          <p className="text-gray-500 mt-2">
            Billed annually at{" "}
            <span className="font-bold text-gray-600">AED 588/year</span>.
          </p>

          <button
            onClick={() =>
              handleSubscription("price_1QW45oBqMEKqDL9c57bYUJFD", "yearly")
            } // Replace with actual Price ID
