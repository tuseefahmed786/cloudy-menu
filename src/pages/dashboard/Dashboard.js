        ...
        <aside className="sm:w-1/5 sm:bg-[#ffffff] text-white p-4 border-r">
          <div className='scrollx flex sm:flex-col overflow-scroll sm:overflow-hidden'>
            ...
            <Link to={fetchMenuLink}>
              <div id="view" className="sm:mb-2 border-b border-b-transparent sm:bg-[#f1f4f9] whitespace-nowrap sm:w-full items-center gap-2 flex text-left mr-4 sm:px-4 sm:py-2 border-2 border-[white] text-[#000000] rounded-lg">
